    ...
    Restaurant.find({})
        .then((foundRestaurants) => {
            if (!foundRestaurants.length) {
                ...
                const restaurants = [
                    { owner: fakeOwner, name: 'Happy', minOrder: 10, deliveryPrice: 0, categories, menu, logoUrl: 'https://webandevents.com/wp-content/uploads/2018/02/20180108-bf2cd9077f486d3dd7ea052b-or.png' },
                    ...
                    { owner: fakeOwner, name: 'Пицария Don Vito', minOrder: 10, deliveryPrice: 0, categories, menu, logoUrl: 'https://ir0.mobify.com/jpg/195/195/http://europe-public.foodpanda.com/assets/production/bg/images/vendors/v9mo.jpg?v=20171101121807' },
                    { owner: fakeOwner, name: 'Дивака', minOrder: 0, deliveryPrice: 5, categories, menu, logoUrl: 'http://divaka.bg/wp-content/uploads/2015/12/logo-en.png' },
                    { owner: fakeOwner, name: 'Raffy', minOrder: 15, deliveryPrice: 2, categories, menu, logoUrl: 'https://scontent-sof1-1.xx.fbcdn.net/v/t1.0-1/57336171_396690377726870_5234490700510265344_n.jpg?_nc_cat=105&_nc_oc=AQk_RAt2Hak8hhAgDi-YIC-sBETC67PW9MHsDFIZLFKBsyAis2McdG3RP5fdGMVyK863fzUN4l0apeyELJ5XtIPn&_nc_ht=scontent-sof1-1.xx&oh=80765b2c57cd6892f50e46c995096e49&oe=5E3D37C6'  }
                ];
