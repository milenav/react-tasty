        ...
        .then((foundRestaurants) => {
            if (!foundRestaurants.length) {
                ...
                const restaurants = [
                    ...
                    { owner: fakeOwner, name: 'Don Vito', minOrder: 10, deliveryPrice: 0, categories, menu, logoUrl: 'https://ir0.mobify.com/jpg/195/195/http://europe-public.foodpanda.com/assets/production/bg/images/vendors/v9mo.jpg?v=20171101121807' },
